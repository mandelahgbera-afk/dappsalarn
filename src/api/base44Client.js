/**
 * base44Client.js - Supabase Adapter Layer
 * 
 * This file provides an adapter that maps the base44-style API calls
 * to actual Supabase database queries. It abstracts the Supabase implementation
 * so that all pages can use `base44.entities.*` patterns.
 * 
 * Entity Methods:
 * - .list(orderBy?, limit?)
...
class Entity {
  ...
  async list(orderBy = null, limit = 100) {
    try {
      ...
      console.error(`[base44] Error listing ${this.tableName}:`, error);
      return [];
    }
  }
  ...
  async filter(conditions = {}, orderBy = null, limit = 100) {
    try {
      ...
      console.error(`[base44] Error filtering ${this.tableName}:`, error);
      return [];
    }
  }
  ...
  async get(id) {
    try {
      ...
      console.error(`[base44] Error getting ${this.tableName} record:`, error);
      return null;
    }
  }
  ...
  async create(data) {
    try {
      ...
      console.error(`[base44] Error creating ${this.tableName} record:`, error);
      return null;
    }
  }
  ...
  async update(id, data) {
    try {
      ...
      console.error(`[base44] Error updating ${this.tableName} record:`, error);
      return null;
    }
  }
  ...
  async delete(id) {
    try {
      ...
      console.error(`[base44] Error deleting ${this.tableName} record:`, error);
      return false;
    }
  }
}
...
export const base44 = {
  ...
  async getCurrentUserProfile() {
    try {
      ...
      console.error('[base44] Error getting current user profile:', error);
      return null;
    }
  },
  ...
  async getUserBalance(userEmail) {
    try {
      ...
      console.error('[base44] Error getting user balance:', error);
      return null;
    }
  },
  ...
  async getUserPortfolio(userEmail) {
    try {
      ...
      console.error('[base44] Error getting portfolio:', error);
      return [];
    }
  },
  ...
  async getUserTransactions(userEmail, limit = 50) {
    try {
      ...
      console.error('[base44] Error getting transactions:', error);
      return [];
    }
  },
  ...
  async getUserCopyTrades(userEmail) {
    try {
      ...
      console.error('[base44] Error getting copy trades:', error);
      return [];
    }
  },
  ...
  async createDepositRequest(userEmail, amount, currency = 'USD') {
    try {
      ...
      console.error('[base44] Error creating deposit request:', error);
      return null;
    }
  },
  ...
  async createWithdrawalRequest(userEmail, amount, currency = 'USD', walletAddress) {
    try {
      ...
      console.error('[base44] Error creating withdrawal request:', error);
      return null;
    }
  },
  ...
  async getPlatformSetting(key) {
    try {
      ...
      console.error('[base44] Error getting platform setting:', error);
      return null;
    }
  },
  ...
  async updatePlatformSetting(key, value, label = null) {
    try {
      ...
      console.error('[base44] Error updating platform setting:', error);
      return null;
    }
  },
};
